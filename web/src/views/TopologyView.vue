  ...
  <div class="h-screen w-screen bg-[#111317] text-slate-200 font-sans flex flex-col overflow-hidden select-none">
    ...
    <header class="h-12 bg-[#171a21] border-b border-slate-800/90 px-4 flex items-center justify-between shrink-0 z-30">
      ...
      <div class="flex items-center gap-2">
        <button
          ...
          class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-emerald-500/80 text-emerald-400 hover:bg-emerald-500/10 text-xs font-semibold tracking-wider transition shadow-sm"
        >
    ...
    <div class="flex-1 flex overflow-hidden relative">
      ...
      >
        ...
        <div class="p-3 border-t border-slate-800 grid grid-cols-4 gap-1.5 bg-[#14161b]">
          <button
          ...
          <button
            ...
            class="py-2 rounded bg-emerald-600/20 hover:bg-emerald-600/30 border border-emerald-500/40 text-emerald-400 text-xs font-bold tracking-wide transition flex items-center justify-center gap-1 shadow-sm"
          >
            <span>PING</span>
          </button>
